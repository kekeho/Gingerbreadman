...
{
	if (region.ag.H === region.at.H)
	{
		return 'on line ' + region.ag.H;
	}
	return 'on lines ' + region.ag.H + ' through ' + region.at.H;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.bE, request.Q, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ay: fragment, aB: host, aL: path, aQ: port_, aV: protocol, aW: query};
	});
...
var $author$project$Visualizer$Model$controllerModelInit = {
	q: {
		...
		P: $elm$time$Time$millisToPosix(0)
	},
	aG: false,
	aa: '',
	aP: _List_Nil,
...
var $author$project$Visualizer$Model$modelInit = {i: $author$project$Visualizer$Model$controllerModelInit, bI: $author$project$Visualizer$Model$peopleInit, bU: $author$project$Visualizer$Model$trafficInit};
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			{M: _List_Nil, aF: key, bM: 0, ae: $author$project$Common$Settings$modelInit, bW: $author$project$Upload$Model$modelInit, Q: url, bY: $author$project$Visualizer$Model$modelInit},
...
var $author$project$Common$Data$Place = F3(
	function (name, latitude, longitude) {
		return {bC: latitude, bD: longitude, aI: name};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bi: false, R: r.R, T: r.T, bu: r.bu, bE: r.bE, bS: r.bS, bT: r.bT, Q: r.Q}));
};
var $author$project$Upload$Upload$getPlaces = $elm$http$Http$request(
	{
		R: $elm$http$Http$emptyBody,
		T: A2($elm$http$Http$expectJson, $author$project$Upload$Upload$GotPlaces, $author$project$Common$Data$placesDecoder),
		bu: _List_fromArray(
			[
...
var $author$project$Visualizer$Controller$getPlaces = $elm$http$Http$request(
	{
		R: $elm$http$Http$emptyBody,
		T: A2($elm$http$Http$expectJson, $author$project$Visualizer$Controller$GotPlace, $author$project$Common$Data$placesDecoder),
		bu: _List_fromArray(
			[
				A2($elm$http$Http$header, 'Accept', 'application/json')
			]),
...
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{R: r.R, T: r.T, bu: _List_Nil, bE: 'POST', bS: $elm$core$Maybe$Nothing, bT: $elm$core$Maybe$Nothing, Q: r.Q});
};
					...
					if (_v1.$ === 1) {
						var $temp$msg = $author$project$Upload$Upload$ErrorMsg(
							$author$project$Common$ErrorPanel$AddError(
								{bo: $author$project$Common$ErrorPanel$OnlyStr, a8: 'NO IMAGE'})),
						...
						if (_v2.$ === 1) {
							if (model.aJ.aI === '') {
								var $temp$msg = $author$project$Upload$Upload$ErrorMsg(
									$author$project$Common$ErrorPanel$AddError(
										{bo: $author$project$Common$ErrorPanel$OnlyStr, a8: 'NO SELECTED PLACE'})),
									$temp$rootModel = newRootModel;
								msg = $temp$msg;
								rootModel = $temp$rootModel;
								continue update;
								...
								return _Utils_Tuple2(
									...
									$elm$http$Http$post(
										{
											R: $elm$http$Http$multipartBody(
												A2(
													$elm$core$List$cons,
													A2($elm$http$Http$stringPart, 'place_selected', ''),
													A2(
														$elm$core$List$cons,
														A2($elm$http$Http$stringPart, 'place_new', model.aJ.aI),
														A2(
															$elm$core$List$cons,
															A2(
																$elm$http$Http$stringPart,
																'new_latitude',
																$elm$core$String$fromFloat(model.aJ.bC)),
															A2(
																$elm$core$List$cons,
																A2(
																	$elm$http$Http$stringPart,
																	'new_longitude',
																	$elm$core$String$fromFloat(model.aJ.bD)),
																_Utils_ap(
																	A2(
																		$elm$core$List$map,
																		function (f) {
																	...
																	A2(
																		...
																		files))))))),
											T: $elm$http$Http$expectWhatever($author$project$Upload$Upload$Uploaded),
											Q: '/api/db/regist_images/'
										}));
							}
						} else {
								...
								$elm$http$Http$post(
									{
										R: $elm$http$Http$multipartBody(
											A2(
												$elm$core$List$cons,
												A2($elm$http$Http$stringPart, 'place_selected', selectedPlace.aI),
												A2(
													$elm$core$List$cons,
													A2($elm$http$Http$stringPart, 'place_new', model.aJ.aI),
													A2(
						...
						return _Utils_Tuple2(
							modelMap(
								_Utils_update(
									...
									{
										a3: $elm$core$Maybe$Nothing,
										bc: $elm$core$Maybe$Just('Uploaded')
									})),
							$elm$core$Platform$Cmd$none);
					} else {
						var error = result.a;
						...
						return _Utils_Tuple2(
							modelMap(
								_Utils_update(
									...
									{
										aN: places,
										aP: $elm$core$Maybe$Just(places),
										a4: $elm$core$List$head(places)
									})),
							$elm$core$Platform$Cmd$none);
					} else {
						var error = result.a;
						var _v5 = A2(
							...
							$author$project$Upload$Upload$ErrorMsg(
								$author$project$Common$ErrorPanel$AddError(
									{
										bo: $author$project$Common$ErrorPanel$HttpError(error),
										a8: 'Failed to load location tags'
									})),
							rootModel);
						var newRootModel = _v5.a;
						var cmd = _v5.b;
						var newModel = newRootModel.bW;
						return _Utils_Tuple2(
							_Utils_update(
								newRootModel,
								{
									bW: _Utils_update(
										newModel,
										{aN: _List_Nil, aP: $elm$core$Maybe$Nothing})
								}),
							cmd);
					}
				case 5:
						...
						if (!_v6.$) {
							...
							return $elm$core$List$head(
								A2(
									$elm$core$List$filter,
									function (p) {
										return _Utils_eq(p.aI, placeString);
									},
									places));
						} else {
							return $elm$core$Maybe$Nothing;
				...
				case 9:
					...
					return _Utils_Tuple2(
						modelMap(
							_Utils_update(
								model,
								{aN: filteredPlaces, aO: keyword})),
						$elm$core$Platform$Cmd$none);
				default:
					var subMsg = msg.a;
					var _v10 = A2($author$project$Common$ErrorPanel$update, subMsg, rootModel.M);
					var model_ = _v10.a;
					var cmd = _v10.b;
					return _Utils_Tuple2(
						_Utils_update(
...
var $author$project$Visualizer$Controller$groupingQuery = function (controllerModel) {
	var timeQuery = _List_fromArray(
		[
			...
			$elm$url$Url$Builder$string,
			'datetime-to',
			$author$project$Common$Settings$dropSecsStr(controllerModel.q.P))
		]);
	return $elm$core$List$isEmpty(controllerModel.s) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
		_Utils_ap(
			...
			A2(
				$elm$core$List$map,
				function (p) {
					return A2($elm$url$Url$Builder$string, 'places', p.aI);
				},
				controllerModel.s)));
};
var $author$project$Visualizer$Model$Face = F9(
	function (id, imageId, imageUrl, faceImageB64, faceLocation, faceEncoding, place, datetime, sex) {
		return {ar: datetime, bq: faceEncoding, br: faceImageB64, bs: faceLocation, bw: id, bx: imageId, by: imageUrl, bJ: place, bO: sex};
	});
...
var $author$project$Visualizer$Controller$analyze = function (rootModel) {
	...
	var errorList = rootModel.M;
	var controllerModel = rootModel.bY.i;
	...
	if (_v0.$ === 1) {
		return _Utils_Tuple2(
			_Utils_update(
				rootModel,
				{
					M: A2(
						$elm$core$List$cons,
						{bo: $author$project$Common$ErrorPanel$OnlyStr, a8: 'Please select places'},
						errorList)
				}),
			$elm$core$Platform$Cmd$none);
	} else {
		...
		return _Utils_Tuple2(
			...
			$elm$http$Http$request(
				{
					R: $elm$http$Http$emptyBody,
					T: A2($elm$http$Http$expectJson, $author$project$Visualizer$Controller$Analyzed, $author$project$Visualizer$Model$peopleDecoder),
					bu: _List_fromArray(
						[
							A2($elm$http$Http$header, 'Accept', 'application/json')
						]),
...
var $author$project$Visualizer$Traffic$personTrafficList = function (person) {
	...
	while (true) {
		...
		if (!_v0.$) {
			...
			if (!_v1.$) {
				var nextFace = _v1.a;
				if (!_Utils_eq(face.bJ, nextFace.bJ)) {
					return A2(
						$elm$core$List$cons,
						_Utils_Tuple2(face.bJ, nextFace.bJ),
...
var $author$project$Visualizer$Model$sortWithTime = function (person) {
	var times = A2(
		...
		function (f) {
			return {
				aw: f,
				aR: $elm$time$Time$posixToMillis(f.ar)
			};
		},
		person);
	var sortedFaces = A2(
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {ap: col, bl: contextStack, aS: problem, a1: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.a1, s.ap, x, s.c));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{ap: col, c: s0.c, d: s0.d, b: offset, a1: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.a1, s.ap, s);
	};
};
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{ap: 1, c: s.c, d: s.d, b: s.b + 1, a1: s.a1 + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{ap: s.ap + 1, c: s.c, d: s.d, b: newOffset, a1: s.a1, a: s.a}));
		};
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.a1, s.ap, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{ap: newCol, c: s.c, d: s.d, b: newOffset, a1: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {ap: col, aS: problem, a1: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.a1, p.ap, p.aS);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{ap: 1, c: _List_Nil, d: 1, b: 0, a1: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Visualizer$Map$bidirectionalTrafficList = function (trafficCountList) {
	if (!trafficCountList.b) {
		...
		var same = A2(
			$elm$core$List$filter,
			function (t) {
				return _Utils_eq(x.bU.a, t.bU.b) && _Utils_eq(x.bU.b, t.bU.a);
			},
			xs);
		var others = A2(
			$elm$core$List$filter,
...
var $author$project$Visualizer$Map$update = F2(
	function (msg, rootModel) {
		var mapUpdate = _List_fromArray(
			[
				$author$project$Visualizer$Map$drawPlaceCircle(rootModel.bY.bI),
				$author$project$Visualizer$Map$drawTrafficLine(rootModel.bY.bU)
			]);
		return _Utils_Tuple2(
			rootModel,
...
var $author$project$Visualizer$Controller$update = F2(
	function (msg, rootModel) {
		var visualizerModel = rootModel.bY;
		var errorList = rootModel.M;
		...
		switch (msg.$) {
			case 0:
				...
				if (!result.$) {
					...
					var cmd = _v2.b;
					var newVisualizierModel = newRootModel.bY;
			...
			case 1:
				...
				var maybePlace = $elm$core$List$head(
					A2(
						$elm$core$List$filter,
						function (p) {
							return _Utils_eq(p.aI, placeName);
						},
						controllerModel.aP));
				if (!maybePlace.$) {
			...
			case 4:
				...
				if (!_v4.$) {
										...
										i: _Utils_update(
											controllerModel,
											{
												q: _Utils_update(
													dateRange,
													{
														O: A2($author$project$Common$Settings$toUTC, rootModel.ae.ai, localTime)
													})
											})
									})
							}),
					...
					var _v5 = A2(
						...
						$author$project$Visualizer$Controller$ErrorMsg(
							$author$project$Common$ErrorPanel$AddError(
								{bo: $author$project$Common$ErrorPanel$OnlyStr, a8: 'Format of since time is invalid'})),
						rootModel);
					var newRootModel = _v5.a;
					var cmd = _v5.b;
			...
			case 5:
				...
				if (!_v6.$) {
										...
										i: _Utils_update(
											controllerModel,
											{
												q: _Utils_update(
													dateRange,
													{
														P: A2($author$project$Common$Settings$toUTC, rootModel.ae.ai, localTime)
													})
											})
									})
							}),
					...
					var _v7 = A2(
						...
						$author$project$Visualizer$Controller$ErrorMsg(
							$author$project$Common$ErrorPanel$AddError(
								{bo: $author$project$Common$ErrorPanel$OnlyStr, a8: 'Format of until time is invalid'})),
						rootModel);
			...
			case 7:
				...
				if (result.$ === 1) {
					...
					var newController = _Utils_update(
						controllerModel,
						{ac: controllerModel.q, a0: controllerModel.s});
					var newRootModel = _Utils_update(
						rootModel,
						{
							bY: _Utils_update(
								visualizerModel,
								{i: newController, bI: people, bU: trafficCount})
						});
			...
			default:
				var subMsg = msg.a;
				var _v12 = A2($author$project$Common$ErrorPanel$update, subMsg, rootModel.M);
		...
		switch (msg.$) {
			...
			case 1:
				...
				var clearMap = function () {
					var _v2 = A2($elm$url$Url$Parser$parse, $author$project$Main$routeParser, rootModel.Q);
					if ((!_v2.$) && (!_v2.a)) {
						var _v3 = _v2.a;
			...
			case 4:
				var subMsg = msg.a;
				var _v11 = A2($author$project$Common$ErrorPanel$update, subMsg, rootModel.M);
				var model_ = _v11.a;
				var cmd = _v11.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				var subMsg = msg.a;
				var _v12 = A2($author$project$Common$Settings$update, subMsg, rootModel.ae);
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$value(model.aJ.aI)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$input,
				...
				A2(
					...
					function (p) {
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$value(p.aI)
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(p.aI)
								]));
					},
					model.aN))
			]));
											...
											[
												...
												_List_fromArray(
													[
														...
														$author$project$Upload$Upload$filesCountView(model.a3)
													]))
											])),
										A2(
										$elm$html$Html$div,
...
var $author$project$Visualizer$Controller$viewControllerState = function (rootModel) {
	...
	var places = A2(
		...
		A2(
			...
			controllerModel.a0));
	var since = A2($author$project$Common$Settings$localDropSecsStr, rootModel.ae.ai, controllerModel.ac.O);
	var until = A2($author$project$Common$Settings$localDropSecsStr, rootModel.ae.ai, controllerModel.ac.P);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$src(face.br),
							$elm$html$Html$Attributes$title(
							face.bJ.aI + (' ' + ($author$project$Visualizer$People$sexString(face.bO) + (' ' + A2($author$project$Common$Settings$localDropSecsStr, timezone, face.ar)))))
						]),
					_List_Nil)
				]));
	});
...
var $author$project$Visualizer$Traffic$trafficCountString = function (trafficCount) {
	...
	var _v0 = trafficCount.bU;
	var from = _v0.a;
	var to = _v0.b;
	return from.aI + (' -> ' + (to.aI + (' : ' + $elm$core$String$fromInt(count))));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Visualizer$Traffic$trafficView(model.bU)
					]))
			]));
};
...
var $author$project$Visualizer$Controller$dateSelectorView = function (rootModel) {
	var hereTimeZone = rootModel.ae.ai;
	var controllerModel = rootModel.bY.i;
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$type_('datetime-local'),
								$elm$html$Html$Attributes$value(
								A2($author$project$Common$Settings$localDropSecsStr, hereTimeZone, controllerModel.q.P)),
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'timezone: ' + $author$project$Common$Settings$timezoneNameString(rootModel.ae.aj))
					]))
			]));
};
...
var $author$project$Visualizer$Controller$allPlacesList = function (controllerModel) {
	return A2(
		...
		A2(
			...
			function (p) {
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Visualizer$Controller$SelectPlace(p.aI))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(p.aI)
			...
			A2($author$project$Common$Data$placesFilter, controllerModel.aa, controllerModel.aP)));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$value(controllerModel.aa),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Events$onClick(
				$author$project$Visualizer$Controller$DelSelectedPlace(place.aI))
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(place.aI)
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Visualizer$Controller$placesView(rootModel.bY.i)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
			...
			return {
				R: _List_fromArray(
					[
						...
						$author$project$Common$ErrorPanel$view(rootModel.M))
					]),
				ak: 'Gingerbreadman | ' + title
			};
		});
	var _v0 = A2($elm$url$Url$Parser$parse, $author$project$Main$routeParser, rootModel.Q);
	if (!_v0.$) {
		if (!_v0.a) {
			var _v1 = _v0.a;
