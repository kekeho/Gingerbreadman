...
var $author$project$Visualizer$Model$Face = F9(
	function (id, imageId, imageUrl, faceImageB64, faceLocation, faceEncoding, place, datetime, sex) {
		return {datetime: datetime, faceEncoding: faceEncoding, faceImageB64: faceImageB64, faceLocation: faceLocation, id: id, imageId: imageId, imageUrl: imageUrl, place: place, sex: sex};
	});
				...
				[
					...
					_List_fromArray(
						[
							...
							face.place.name + (' ' + ($author$project$Visualizer$People$sexString(face.sex) + (' ' + A2($author$project$Common$Settings$localDropSecsStr, timezone, face.datetime)))))
						]),
					_List_Nil)
				]));
	});
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$value(
								A2($author$project$Common$Settings$localDropSecsStr, hereTimeZone, controllerModel.dateRange.since)),
					...
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$type_('datetime-local'),
								$elm$html$Html$Attributes$value(
								A2($author$project$Common$Settings$localDropSecsStr, hereTimeZone, controllerModel.dateRange.until)),
