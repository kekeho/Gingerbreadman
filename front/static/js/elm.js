...
var $author$project$Visualizer$Model$controllerModelInit = {
	...
	inputDateRange: {since: '2000-01-01T00:00', until: '2000-01-01T00:00'},
	modalState: false,
	placeSearchKeyword: '',
	places: _List_Nil,
	resultDateRange: {
...
var $author$project$Visualizer$Model$graphInit = {focusPlaces: _List_Nil};
var $author$project$Visualizer$Model$peopleInit = _List_Nil;
var $author$project$Visualizer$Model$trafficInit = _List_Nil;
var $author$project$Visualizer$Model$modelInit = {controller: $author$project$Visualizer$Model$controllerModelInit, graph: $author$project$Visualizer$Model$graphInit, people: $author$project$Visualizer$Model$peopleInit, traffic: $author$project$Visualizer$Model$trafficInit};
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			{analyzeMonitor: $author$project$AnalyzeMonitor$Model$modelInit, errorList: _List_Nil, key: key, route: $author$project$Model$VisualizerPage, settings: $author$project$Common$Settings$modelInit, upload: $author$project$Upload$Model$modelInit, url: url, visualizer: $author$project$Visualizer$Model$modelInit},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						A2(
...
var $author$project$Upload$Upload$getPlaces = $elm$http$Http$request(
	{
		...
		expect: A2($elm$http$Http$expectJson, $author$project$Upload$Upload$GotPlaces, $author$project$Common$Data$placesDecoder),
...
var $author$project$Visualizer$Controller$getPlaces = $elm$http$Http$request(
	{
		body: $elm$http$Http$emptyBody,
		expect: A2($elm$http$Http$expectJson, $author$project$Visualizer$Controller$GotPlace, $author$project$Common$Data$placesDecoder),
		headers: _List_fromArray(
			[
				A2($elm$http$Http$header, 'Accept', 'application/json')
			]),
...
var $author$project$Model$AnalyzeMonitor = {$: 'AnalyzeMonitor'};
var $author$project$Model$UploadPage = {$: 'UploadPage'};
...
var $author$project$Main$routeParser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2($elm$url$Url$Parser$map, $author$project$Model$VisualizerPage, $elm$url$Url$Parser$top),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Model$UploadPage,
...
var $author$project$Common$ErrorPanel$OnlyStr = {$: 'OnlyStr'};
			...
			switch (msg.$) {
					...
					return _Utils_Tuple2(
						modelMap(
							_Utils_update(
								model,
								{
									selectedImages: $elm$core$Maybe$Just(
				...
				case 'Upload':
					...
					var newRootModel = _Utils_update(
						rootModel,
						{upload: newModel});
					var _v1 = model.selectedImages;
					if (_v1.$ === 'Nothing') {
						var $temp$msg = $author$project$Upload$Upload$ErrorMsg(
							$author$project$Common$ErrorPanel$AddError(
								{error: $author$project$Common$ErrorPanel$OnlyStr, str: 'NO IMAGE'})),
								...
								$elm$http$Http$post(
									{
										body: $elm$http$Http$multipartBody(
											A2(
												$elm$core$List$cons,
												A2($elm$http$Http$stringPart, 'place_selected', selectedPlace.name),
												A2(
													$elm$core$List$cons,
													A2($elm$http$Http$stringPart, 'place_new', model.newPlace.name),
													A2(
						...
						return _Utils_Tuple2(
							modelMap(
								_Utils_update(
									...
									{
										selectedImages: $elm$core$Maybe$Nothing,
										uploadedIndicator: $elm$core$Maybe$Just('Uploaded')
									})),
							$elm$core$Platform$Cmd$none);
					} else {
						var error = result.a;
						...
						return _Utils_Tuple2(
							modelMap(
								_Utils_update(
									model,
									{
										placeSearchFiltered: places,
										places: $elm$core$Maybe$Just(places),
										selectedPlace: $elm$core$List$head(places)
									})),
							$elm$core$Platform$Cmd$none);
					} else {
						var error = result.a;
						var _v5 = A2(
							...
							$author$project$Upload$Upload$ErrorMsg(
								$author$project$Common$ErrorPanel$AddError(
									{
										error: $author$project$Common$ErrorPanel$HttpError(error),
										str: 'Failed to load location tags'
									})),
							rootModel);
						var newRootModel = _v5.a;
						var cmd = _v5.b;
						var newModel = newRootModel.upload;
						return _Utils_Tuple2(
							_Utils_update(
								newRootModel,
								{
									upload: _Utils_update(
										newModel,
										{placeSearchFiltered: _List_Nil, places: $elm$core$Maybe$Nothing})
								}),
							cmd);
					}
				case 'PlaceSelected':
						...
						if (_v6.$ === 'Just') {
							...
							return $elm$core$List$head(
								A2(
									$elm$core$List$filter,
									function (p) {
										return _Utils_eq(p.name, placeString);
									},
									places));
						} else {
							return $elm$core$Maybe$Nothing;
				...
				case 'NewPlaceName':
					var name = msg.a;
					var newPlace = model.newPlace;
					return _Utils_Tuple2(
						modelMap(
							_Utils_update(
								model,
								{
									newPlace: _Utils_update(
										newPlace,
										{name: name})
								})),
						$elm$core$Platform$Cmd$none);
				case 'NewPlaceLatitude':
					var latitude = msg.a;
					var newPlace = model.newPlace;
					var lat = function () {
				...
				case 'PlaceSearchInput':
					...
					return _Utils_Tuple2(
						modelMap(
							_Utils_update(
								model,
								{placeSearchFiltered: filteredPlaces, placeSearchInput: keyword})),
						$elm$core$Platform$Cmd$none);
				default:
					var subMsg = msg.a;
...
var $author$project$Visualizer$Controller$groupingQuery = function (controllerModel) {
	var timeQuery = _List_fromArray(
		[
			...
			'datetime-from',
			$author$project$Common$Settings$dropSecsStr(controllerModel.dateRange.since)),
			A2(
			$elm$url$Url$Builder$string,
			'datetime-to',
			$author$project$Common$Settings$dropSecsStr(controllerModel.dateRange.until))
		]);
	return $elm$core$List$isEmpty(controllerModel.selectedPlaces) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
		_Utils_ap(
			timeQuery,
			A2(
				$elm$core$List$map,
				function (p) {
					return A2($elm$url$Url$Builder$string, 'places', p.name);
				},
				controllerModel.selectedPlaces)));
};
					...
					return function (faceEncoding) {
						return function (place) {
							return function (datetime) {
								return function (sex) {
									return function (age) {
										return {age: age, datetime: datetime, faceEncoding: faceEncoding, faceImageB64: faceImageB64, faceLocation: faceLocation, id: id, imageId: imageId, imageUrl: imageUrl, place: place, sex: sex};
									};
								};
							};
						};
...
var $author$project$Visualizer$Model$Female = {$: 'Female'};
var $author$project$Visualizer$Model$Male = {$: 'Male'};
var $author$project$Visualizer$Model$NotKnown = {$: 'NotKnown'};
var $author$project$Visualizer$Model$intToSex = function (val) {
	switch (val) {
		case 1:
			return $author$project$Visualizer$Model$Male;
		case 2:
			return $author$project$Visualizer$Model$Female;
		default:
			return $author$project$Visualizer$Model$NotKnown;
	}
};
...
var $author$project$Visualizer$Controller$analyze = function (rootModel) {
	...
	var errorList = rootModel.errorList;
	...
	if (_v0.$ === 'Nothing') {
		return _Utils_Tuple2(
			_Utils_update(
				rootModel,
				{
					errorList: A2(
						$elm$core$List$cons,
						{error: $author$project$Common$ErrorPanel$OnlyStr, str: 'Please select places'},
						errorList)
				}),
			$elm$core$Platform$Cmd$none);
	} else {
		...
		return _Utils_Tuple2(
			...
			$elm$http$Http$request(
				{
					body: $elm$http$Http$emptyBody,
					expect: A2($elm$http$Http$expectJson, $author$project$Visualizer$Controller$Analyzed, $author$project$Visualizer$Model$peopleDecoder),
					headers: _List_fromArray(
						[
							A2($elm$http$Http$header, 'Accept', 'application/json')
						]),
...
var $author$project$Visualizer$Controller$update = F2(
	function (msg, rootModel) {
		...
		var errorList = rootModel.errorList;
		var controllerModel = visualizerModel.controller;
		switch (msg.$) {
			case 'GotPlace':
				var result = msg.a;
				if (result.$ === 'Ok') {
					...
					var cmd = _v2.b;
					var newVisualizierModel = newRootModel.visualizer;
					var newControllerModel = newVisualizierModel.controller;
					return _Utils_Tuple2(
						_Utils_update(
							newRootModel,
							{
			...
			case 'SelectPlace':
				...
				var maybePlace = $elm$core$List$head(
					A2(
						...
						controllerModel.places));
				if (maybePlace.$ === 'Just') {
					var place = maybePlace.a;
					return A2($elm$core$List$member, place, controllerModel.selectedPlaces) ? _Utils_Tuple2(rootModel, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						_Utils_update(
							rootModel,
							{
								visualizer: _Utils_update(
			...
			case 'GotSinceTime':
				var str = msg.a;
				var inputDateRange = controllerModel.inputDateRange;
				return _Utils_Tuple2(
					_Utils_update(
						rootModel,
						{
			...
			case 'ValidSinceTime':
				...
				var dateRange = controllerModel.dateRange;
				...
				if (_v4.$ === 'Ok') {
								...
								visualizer: _Utils_update(
									visualizerModel,
									{
										controller: _Utils_update(
											controllerModel,
											{
												dateRange: _Utils_update(
													dateRange,
													{
														since: A2($author$project$Common$Settings$toUTC, rootModel.settings.timezone, localTime)
													})
											})
									})
							}),
					...
					var _v5 = A2(
						...
						$author$project$Visualizer$Controller$ErrorMsg(
							$author$project$Common$ErrorPanel$AddError(
								{error: $author$project$Common$ErrorPanel$OnlyStr, str: 'Format of since time is invalid'})),
						rootModel);
					var newRootModel = _v5.a;
					var cmd = _v5.b;
			...
			case 'ValidUntilTime':
				...
				if (_v6.$ === 'Ok') {
										...
										controller: _Utils_update(
											controllerModel,
											{
												dateRange: _Utils_update(
													dateRange,
													{
														until: A2($author$project$Common$Settings$toUTC, rootModel.settings.timezone, localTime)
													})
											})
									})
							}),
					...
					var _v7 = A2(
						...
						$author$project$Visualizer$Controller$ErrorMsg(
							$author$project$Common$ErrorPanel$AddError(
								{error: $author$project$Common$ErrorPanel$OnlyStr, str: 'Format of until time is invalid'})),
						rootModel);
...
var $author$project$Main$update = F2(
	function (msg, rootModel) {
		switch (msg.$) {
			...
			default:
				var subMsg = msg.a;
				var _v13 = A2($author$project$Common$Settings$update, subMsg, rootModel.settings);
...
var $author$project$Upload$Upload$ImageRequested = {$: 'ImageRequested'};
var $author$project$Upload$Upload$Upload = {$: 'Upload'};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$value(model.newPlace.name)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$input,
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$value(model.placeSearchInput)
					]),
				_List_Nil),
				A2(
...
var $author$project$Visualizer$Graph$Age = {$: 'Age'};
			...
			function (index, datum) {
				return A2(
					...
					$gampleman$elm_visualization$Shape$arc(
						_Utils_update(
							datum,
							{innerRadius: ($author$project$Visualizer$Graph$radius * 2) - 10})),
					_List_fromArray(
						[
							$elm_community$typed_svg$TypedSvg$Attributes$fill(
							$elm_community$typed_svg$TypedSvg$Types$Paint(
		...
		var makeLabels = F2(
			function (index, _v3) {
				...
				var _v0 = $gampleman$elm_visualization$Shape$centroid(
					_Utils_update(
						datum,
						{innerRadius: $author$project$Visualizer$Graph$radius * 2, outerRadius: ($author$project$Visualizer$Graph$radius * 2) + 10}));
				var x = _v0.a;
				var y = _v0.b;
...
var $author$project$Visualizer$Graph$hourFormat = F2(
	function (timezone, time) {
		return $elm$core$String$fromInt(
			A2($justinmimbs$time_extra$Time$Extra$posixToParts, timezone, time).hour);
	});
...
var $author$project$Visualizer$Graph$sexDetect = function (person) {
	var m = $elm$core$List$length(
		A2(
			$elm$core$List$filter,
			function (face) {
				return _Utils_eq(face.sex, $author$project$Visualizer$Model$Male);
			},
			person));
	var f = $elm$core$List$length(
		A2(
			$elm$core$List$filter,
			function (face) {
				return _Utils_eq(face.sex, $author$project$Visualizer$Model$Female);
			},
			person));
...
var $author$project$Visualizer$Graph$sexPer = function (people) {
	var n = $elm$core$List$length(
		A2(
			...
			function (p) {
				return _Utils_eq(
					$author$project$Visualizer$Graph$sexDetect(p),
					$author$project$Visualizer$Model$NotKnown);
			},
			people));
	var m = $elm$core$List$length(
		A2(
			...
			function (p) {
				return _Utils_eq(
					$author$project$Visualizer$Graph$sexDetect(p),
					$author$project$Visualizer$Model$Male);
			},
			people));
	var f = $elm$core$List$length(
		A2(
			...
			function (p) {
				return _Utils_eq(
					$author$project$Visualizer$Graph$sexDetect(p),
					$author$project$Visualizer$Model$Female);
			},
			people));
	return A2(
		$elm$core$List$map,
...
var $author$project$Visualizer$Graph$Sex = {$: 'Sex'};
				...
				[
					...
					_List_fromArray(
						[
							...
							face.place.name + (' ' + ($author$project$Visualizer$People$sexString(face.sex) + (' ' + ($author$project$Visualizer$People$ageString(face.age) + (' ' + A2($author$project$Common$Settings$localDropSecsStr, timezone, face.datetime)))))))
						]),
					_List_Nil)
				]));
	});
...
var $author$project$Visualizer$Controller$dateSelectorView = function (rootModel) {
	var hereTimeZone = rootModel.settings.timezone;
	var controllerModel = rootModel.visualizer.controller;
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$value(controllerModel.inputDateRange.since),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$type_('datetime-local'),
								$elm$html$Html$Attributes$value(controllerModel.inputDateRange.until),
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'timezone: ' + $author$project$Common$Settings$timezoneNameString(rootModel.settings.timezoneName))
					]))
			]));
};
var $author$project$Visualizer$Controller$SelectPlace = function (a) {
	return {$: 'SelectPlace', a: a};
};
...
var $author$project$Visualizer$Controller$allPlacesList = function (controllerModel) {
	return A2(
		...
		A2(
			...
			function (p) {
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Visualizer$Controller$SelectPlace(p.name))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(p.name)
			...
			A2($author$project$Common$Data$placesFilter, controllerModel.placeSearchKeyword, controllerModel.places)));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$value(controllerModel.placeSearchKeyword),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Events$onClick(
				$author$project$Visualizer$Controller$DelSelectedPlace(place.name))
			]),
		_List_fromArray(
			[
...
var $author$project$Visualizer$Controller$selectedPlacesView = function (controllerModel) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$Visualizer$Controller$selectedPlaceBox, controllerModel.selectedPlaces));
};
			...
			return {
				body: _List_fromArray(
					[
						...
						$author$project$Common$ErrorPanel$view(rootModel.errorList))
					]),
				title: 'Gingerbreadman | ' + title
			};
		});
	var _v0 = A2($elm$url$Url$Parser$parse, $author$project$Main$routeParser, rootModel.url);
	if (_v0.$ === 'Just') {
		switch (_v0.a.$) {
			case 'VisualizerPage':
				var _v1 = _v0.a;
